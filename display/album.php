...
function displayAlbumCovers($dirToLookIn, $dataArray)
{
    ...
    echo '<br><br><table class="jz_album_cover_table" width="' . $main_table_width . '%" cellpadding="0" cellspacing="0" border="0"><tr>' . "\n";
    ...
    for ($c = 0, $cMax = count($dataArray); $c < $cMax; $c++) {
        ...
        if ('' != $FullAlbumName and '' != $img_src) {
            ...
            echo '<td class="jz_album_cover_table_td" valign="top"><nobr>'
                 . "\n"
