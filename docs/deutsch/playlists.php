...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            ...
            <br><br>
            <strong>Creating Custom Playlists</strong>
            <br><br>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td width="30%" class="bodyBody" valign="top">
                        <strong>Session Playlist</strong>
                    </td>
            ...
            <br><br>
            <strong>Viewing Playlists</strong>
            <br><br>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td width="30%" class="bodyBody" valign="top">
                        <strong>Deleting an Playlist</strong>
                    </td>
                    <td width="70%" class="bodyBody">
                ...
                <tr>
                    <td width="30%" class="bodyBody" valign="top">
                        <strong>Sending an Playlist</strong>
                    </td>
                    <td width="70%" class="bodyBody">
