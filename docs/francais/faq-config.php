...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            <strong>FAQ sur la Configuration</strong>:<br>
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#readtracks"> Jinzora peut-il lire les fichiers d'un dossier situ&eacute; ailleurs que dans son arborescence?</a>
                        <br>
                        <br></td>
                </tr>
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#readotherserver">Jinzora peut-il lire des fichiers situ&eacute;s sur un tout autre serveur que celui o&ugrave; il est h&eacute;berg&eacute;?</a><br>
                        <br></td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#iisotherdrive">Avec IIS les fichiers peuvent-ils &ecirc;tre sur un autre disque dur que celui o&ugrave; est install&eacute; Jinzora?</a><br>
                        <br></td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#permissions">Jinzora arrive &agrave; lire la musique, mais je ne peux pas uploader/cr&eacute;er/effacer/t&eacute;l&eacute;charger, que se passe-t'il?</a><br>
                        <br></td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#ftp">Dans quelle mesure les pistes sont-elles &eacute;galement disponible via FTP?</a><br>
                        <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#tooshort">Que faire si les titres des artistes/genres sont trop courts?</a><br>
                        <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#wording">Comment changer la terminologie (les termes) employ&eacute;e par Jinzora?</a><br>
                        (par exemple changer la d&eacute;nomination &quot;genre&quot; en autre chose)<br>
                        <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#video">Jinzora peut-il streamer de la vid&eacute;o?</a><br>
                        <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#users">Comment cr&eacute;er de nouveaux utilisateurs?</a><br>
                        <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#imagesize">Quelle dimension devraient avoir mes pochettes d'albums?</a><br>
                        <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#resolution"> Jinzora est pr&eacute;vu pour &ecirc;tre affich&eacute; en quelle r&eacute;solution?</a><br>
                        <br></td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#ssl">Puis-je utiliser Jinzora au travers d'un tunnel SSL?</a><br>
                        <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#uploads">Pourquoi les uploads ne marchent-ils pas tout le temps?</a><br>
                        <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#imageslooklikecrap">Pourquoi les pochettes d'albums ont parfois l'air &quot;moches&quot;?</a><br>
                        <br>
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="readtracks">Can Jinzora read tracks that are in another folder that is NOT under the Jinzora directory?</a></strong><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="readotherserver">Can Jinzora read tracks that are on a different server entirely?</a></strong><br><br>
                        Yes, it does take some work though. Here's 2 examples:<br><br>
                        <strong>Windows:</strong> On Windows you'd need to use NFS. NFS (Network File System) is pretty easy to setup and configure,
                        ...
                        <strong>*NIX</strong> On *NIX you have several different options. The one I use is Samba. I share my MP3's from a remote server
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="iisotherdrive">When using IIS can files be on a different drive from where Jinzora is installed?</a></strong><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="permissions">Jinzora can play music, but I can't upload/create genres/delete genres/download, what gives?</a></strong><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="ftp">How can the tracks also be accessible through FTP?</a></strong><br>
                        <br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="tooshort">The artists/album names are too short</a></strong><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="wording">How can I change the wording (terms) used in Jinzora?</a></strong><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="video">Can Jinzora stream video?</a></strong><br><br>
                        Yes. Jinzora <em>should</em> be able to stream any file that can stream over HTTP. All you need to do
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="users">How do I create new users for Jinzora?</a></strong><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="imagesize">What dimensions should my album art be?</a></strong><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="resolution">What screen resolution is Jinzora designed for?</a></strong><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="ssl">Can Jinzora run through SSL?</a></strong><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="uploads">Why don't uploads work all the time?</a></strong><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <strong><a name="imageslooklikecrap">Why do the album art images look like crap sometimes?</a></strong><br><br>
