...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            <strong><strong>Installation</strong> dans PHPNuke</strong><br>
            <br>
            Installer Jinzora tout seul est de loin l'installation la plus simple. Nous recommandons de commencer avec ce type d'installation m&ecirc;me si vous envisagez de l'int&eacute;grer par la suite &agrave; un CMS (m&ecirc;me si le mode integr&eacute; devrait parfaitement fonctionner).
            <br>
            <br>
            ...si vous vous sentez d'attaque on continue!
            <br>
            <br>
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                ...
                <tr>
                    ...
                    <td width="60%" class="bodyBody">
                        Une fois Jinzora t&eacute;l&eacute;charg&eacute; vous devrez extraire puis transf&eacute;rer le contenu sur votre serveur.
                        <br><br>
                        <strong>Windows:</strong>Sur Windows nous recommandons l'usage de <a href="http://www.winzip.com" target="_blank">Winzip</a> pour extraire vos fichiers .zip (en consid&eacute;rant que vous aurez t&eacute;l&eacute;charg&eacute; un fichier zipp&eacute;).
                        <br><br>
                        <strong>*NIX:</strong>Sous *NIX vous devrez lancer un: <code>tar -zxvf jinzora-X.X.tar.gz</code> (ou X.X est le num&eacute;ro de version) pour extraire Jinzora dans le dossier courant (note: Jinzora ne cr&eacute;era PAS de sous-dossier)
                        <br><br>
                        <strong>NOTE:</strong>Ce dossier DOIT &ecirc;tre plac&eacute; dans le dossier /modules de votre PHPNuke.
                        <br><br><br><br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="60%" class="bodyBody">
                        ...
                        Vous pouvez placer vos donn&eacute;es sur un disque diff&eacute;rent SI et UNIQUEMENT SI vous utilisez une partition NTFS (cf <a href="symlinking.php" target="Body">symlinking</a> dans &quot;Utiliser Jinzora&quot;)
                        <br>
                        Vous devez aussi &ecirc;tre s&ucirc;r que votre serveur dispose au moins un acc&egrave;s en lecture sur le dossier dans lequel vous avez extrait (qui devrait l'&ecirc;tre &agrave; moins que vous n'ayez chang&eacute; quelque chose...)
                        <br>
                        <br>
                        ...
                        reportez vous au chapitre d&eacute;di&eacute; &agrave; <a href="ftp-only.php" target="Body">l'installation par FTP uniquement</a>)
                        <br>
                        <br><br><br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="60%" class="bodyBody">
                        Pour profiter des fonctions de redimensionnement des images dans Jinzora vous aurez besoin des librairies d'image de <a href="http://www.boutell.com/gd/" target="_blank">Boutell.com</a>.
                        Pour les installer (dans les grandes lignes)
                        :<br>
                        <br>
                        <strong><strong><strong>Environnement</strong></strong> Windows:</strong>
                        <br>
                ...
                <tr>
                    <td width="40%" class="bodyBody" valign="top">
                        <li><strong>Liens PHPNuke</strong></li>
                    </td>
                    <td width="60%" class="bodyBody">
                        Ok, vous allez maintenant cr&eacute;er les liens dans votre menu PHPNuke. Rien ne vous oblige &agrave; suivre cette &eacute;tape, mais la plupart des utilisateurs de Jinzora/PHPNuke le voudront. Pour ajouter le lien &agrave; votre bloc:<br>
                        <br>
                        ...
                        <br>
                        <br>
                        Et le lien vers Jinzora appara&icirc;tra dans votre menu PHPNuke
                        <br>
                        <br>
                        Cliquez sur les liens r&eacute;cemment cr&eacute;es (vous pouvez poursuivre)
                        <br>
                        <br><br><br></td>
                </tr>
                <tr>
                    ...
                    <td width="60%" class="bodyBody">
                        Vous allez suivre la proc&eacute;dure d'installation via l'interface web. Elle sera document&eacute;e tout au long des diff&eacute;rentes pages, et les diff&eacute;rentes options vous seront expliqu&eacute;es.
                        <br>
                        <br><br><br>
                    </td>
                </tr>
