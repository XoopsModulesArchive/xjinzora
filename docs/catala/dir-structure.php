            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td width="70%" class="bodyBody">
                        ...
                        <br><br>
                        <strong>NOTE:</strong> This is how the primary developer uses Jinzora, therefor it will be
                ...
                <tr>
                    ...
                    <td width="70%" class="bodyBody">
                        ...
                        items will be found in this structure and will use it to display the different style pages.
                        <br><br>
                        <strong>NOTE:</strong> This is most definetly the least tested structure!
                        <br><br>
                        <br><br>
                    </td>
                </tr>
