...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            <b>Standalone Installation</b><br>
            <br>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td width="60%" class="bodyBody">
                        ...
                        <br><br>
                        <b>Note</b>: Jinzora WILL create a subdirectory called "jinzora"
                        <br><br><br><br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="60%" class="bodyBody">
                        ...
                        sh configure.sh
                        <br><br>
                        <b>FTP Only Installtations</b>: If you do not have SSH access and only have FTP access (or similar) please see "FTP Only" installation
