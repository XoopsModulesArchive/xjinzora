        ...
        <td width="100%" class="bodyBody">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#whatis">What is Jinzora?</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#whydevelop">Why develop Jinzora?</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#requirements">What are Jinzora's requirements?</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#shoutcast">Do I need Shoutcast or some other streaming server setup to use Jinzora?</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#bandwidth">How much bandwidth does Jinzora use?</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#howhelp">How can I help Jinzora?</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#filesharing">Is Jinzora similar to KaZaA and other filesharing apps?</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#winampwma">Why won't Winamp play WMA files?</a><br><br>
                    </td>
                </tr>
            </table>
            <br><br><br><br><br><br>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="whatis">What is Jinzora?</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="whydevelop">Why Develop Jinzora?</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="requirements">What are Jinzora's Requirements?</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="shoutcast">Do I need Shoutcast or some other streaming server setup to use Jinzora?</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="bandwidth">How much bandwidth does Jinzora use?</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="howhelp">How can I help Jinzora?</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="filesharing">Is Jinzora similar to KaZaA and other file sharing apps?</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="winampwma">Why won't Winamp play WMA files?</a></b><br><br>
