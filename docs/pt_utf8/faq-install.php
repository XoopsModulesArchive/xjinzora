        ...
        <td width="100%" class="bodyBody">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#filenotexist">File you requested does not exist error</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#cantaccessdirectly">You can't access this file directly</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#filenotexist">Cannot open settings file for writing</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#settingsfile">Why can't the installer write the settings file?</a><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="1%" valign="top" class="bodyBody">
                    ...
                    <td width="99%" class="bodyBody">
                        <a href="#secureftp">How do I secure Jinzora without terminal access (via FTP)?</a><br><br>
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="filenotexist">File you requested does not exist error</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="cantaccessdirectly">You can't access this file directly</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="filenotexist">Cannot open settings file for writing</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="settingsfile">Why can't the installer write the settings file?</a></b><br><br>
                ...
                <tr>
                    ...
                    <td width="99%" class="bodyBody">
                        <b><a name="secureftp">How do I secure Jinzora without terminal access (via FTP)?</a></b><br><br>
