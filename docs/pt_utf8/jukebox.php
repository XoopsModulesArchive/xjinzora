...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            ...
            <br><br>
            <b>NOTE:</b> (for *NIX users) Remember when testing the mpg123 (or whatever you test with)
            needs to be able to run and play audio AS the webserver user, since that's how Jinzora will interact with
            your audio hardware.
            <br><br><br><br>
            <b>Setting up on *NIX</b><br>
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td width="99%" class="bodyBody" valign="top">
                                    ...
                                    <br>
                                    <b>NOTE:</b> You WILL NOT be able to install XMMS-Shell if you haven't completed this!
                                    <br><br>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td width="30%" class="bodyBody" valign="top">
                        <li><b>Setting noxmms to run at boot</b></li>
                    </td>
                    <td width="70%" class="bodyBody">
