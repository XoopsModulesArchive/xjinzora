...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            <b>PHPNuke Installation</b><br>
            <br>
            Installing Jinzora in standalone mode is by far the easiest installation. We recommend
            that even if you're going to use Jinzora integrated into a CMS, that you start with standalone
            mode (although the integrated modes should work perfectly fine).
            <br><br>
            ...so if you're feeling brave continue on below!
            <br><br>
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                ...
                <tr>
                    ...
                    <td width="60%" class="bodyBody">
                        ...
                        <br><br>
                        <b>NOTE:</b> This directory MUST be located within the /modules directory of your PHPNuke installation
                        <br><br><br><br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="60%" class="bodyBody">
                        <b>Windows Users:</b> You MUST make sure that the jinzora directory from above is
                        ...
                        <br><br>
                        <b>*NIX Users:</b> To make installing Jinzora on *NIX easier (and for those that have SSH access)
                ...
                <tr>
                    ...
                    <td width="60%" class="bodyBody">
                        ...
                        <br><br>
                        <b>*NIX Users:</b> This can be a bit more complicated on *NIX, so we recommend you view the installation guide
                ...
                <tr>
                    <td width="40%" class="bodyBody" valign="top">
                        <li><b>PHPNuke Links</b></li>
                    </td>
                    <td width="60%" class="bodyBody">
                        Ok, now you'll need to create the links in your PHPNuke menu block so you can access Jinzora. You don't have to do this,
                        but most users will want to. To add the link to the standard menu block:<br><br>
                        In the PHPNuke Administration Screen<br>
                        Go to "Administration"<br>
                        Click on "Blocks"<br>
                        Click on "View Blocks"<br>
                        Click on "Edit" for the "Main Menu"<br>
                        Add the following:<br>
                        Title: "Jinzora"<br>
                        (or whatever you want to call it)<br><br>
                        URL: "[jinzora]"<br>
                        (or the name of the Jinzora directory)<br><br>
