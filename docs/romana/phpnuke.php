...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            <strong>PHPNuke Installation</strong><br>
            <br>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td width="60%" class="bodyBody">
                        ...
                        <br><br>
                        <strong>NOTE:</strong> This directory MUST be located within the /modules directory of your PHPNuke installation
                        <br><br><br><br>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="40%" class="bodyBody" valign="top">
                        <li><strong>PHPNuke Links</strong></li>
                    </td>
                    <td width="60%" class="bodyBody">
