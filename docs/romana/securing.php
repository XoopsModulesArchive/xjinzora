...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            <strong>Securing Jinzora</strong><br>
            <br>
            ...
            <strong>DISCLAIMER</strong> In NO WAY is the Jinzora Development Team responsible for the
            securing of your data!!!
            <br><br>
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td width="30%" class="bodyBody" valign="top">
                        <strong>Jinzora Users</strong>
                    </td>
                    <td width="70%" class="bodyBody">
                        ...
                        <strong>Admin:</strong> Just what you think this user type can do just about everything
                        <br><br>
                        <strong>Power User:</strong> Very similiar to an Admin, but they can't use the "Tools" section
                        <br><br>
                        <strong>User:</strong> A user can play music, but NOT download (only Power Users can)
                        <br><br>
                        <strong>View Only:</strong> Pretty obvious, don't you think?
                        <br><br><br><br>
                    </td>
                </tr>
                <tr>
                    <td width="30%" class="bodyBody" valign="top">
                        <strong>Securing<br>Apache</strong>
                    </td>
                    <td width="70%" class="bodyBody">
                ...
                <tr>
                    <td width="30%" class="bodyBody" valign="top">
                        <strong>Preventing Right Clicks</strong>
                    </td>
                    <td width="70%" class="bodyBody">
                        ...
                        <strong>NOTE:</strong> This feature is NOT supported in upgrades. You'll need to set this in system.php each time you
                        upgrade Jinzora.
                        <br><br><br><br>
                    </td>
                </tr>
