...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            <strong>Bulk Editing Media</strong><br>
            <br>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td width="30%" class="bodyBody" valign="top">
                        <strong>Rewrite ID3 Tags</strong>
                    </td>
                    <td width="70%" class="bodyBody">
                ...
                <tr>
                    ...
                    <td width="70%" class="bodyBody">
                        ...
                        <br><br>
                        <strong>Search & Replace</strong> - This will also you to edit the names of tracks and bulk remove information. Say
                        each track has the artist name in it, and you'd like to clean it up by removing that.
                        <br><br>
                        <strong>Fix Filename Case</strong> - This will change a track name from:<br><br>
                        07 - all blues.mp3
                        <br><br>
                        to
                        <br><br>
