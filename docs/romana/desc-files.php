...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            <strong>Description Files</strong>
            <br><br>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td width="30%" valign="top" class="bodyBody">
                        <strong>Genre Sub Description</strong>
                    </td>
                    <td width="70%" class="bodyBody">
                ...
                <tr>
                    <td width="30%" valign="top" class="bodyBody">
                        <strong>Track View:<br>Album Description</strong>
                    </td>
                    <td width="70%" class="bodyBody">
                        ...
                        <br><br>
                        <strong>ARTIST_NAME</strong> When you use this variable in your description files it will
                        be replaced by the name of the artist you are viewing
                        <br><br>
                        <strong>ALBUM_NAME</strong> When you use this variable in your description files it will
                ...
                <tr>
                    <td width="30%" valign="top" class="bodyBody">
                        <strong>Track View:<br>Track Description</strong>
                    </td>
                    <td width="70%" class="bodyBody">
