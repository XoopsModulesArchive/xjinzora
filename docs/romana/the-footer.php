...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            <strong>Jinzora's Footer</strong>
            <br><br>
            You can change the contents of the footer in a few ways. They are:
            <br><br>
            <strong>Turning off the Footer</strong> - You can completely turn off the footer if you wish by
            editing "system.php" and changing the line to:
            <br><br>
            $show_jinzora_footer = false;
            <br><br>
            <strong>Footer Text</strong> - You can easily add text to the footer that will display on all
            ...
            <br><br>
            <strong>Jinzora Logo</strong> - If you wish you may remove the Jinzora logo in the footer. While
