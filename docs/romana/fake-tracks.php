...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            ...
            <strong>Full Track Name.fake.txt</strong><br><br>
            Jinzora will then display that track as:<br><br>
            <strong>Full Track Name</strong><br><br>
    ...
    <tr>
        <td width="100%" class="bodyBody">
            <strong>Fake Linked Tracks</strong>
            <br><br>
            ...
            <strong>Full Track Name.fake.lnk</strong><br><br>
            Jinzora will then display that track as:<br><br>
            <strong>Full Track Name</strong><br><br>
