...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td width="100%" class="bodyBody">
            <strong>Prérequis Windows</strong>
            <br><br>
            Les Prérequis pour utiliser Jinzora sous Windows sont:<br><br>
            <li>PHP 4.x (la 5.0 bêta devrait marcher, mais n'a pas été testée)</li>
            <br>
            <li>IIS ...ou... Apache 1.x/2.x<br>
                &nbsp;&nbsp;&nbsp;(seuls Apache et ISS sont supportés)
            </li>
            <br>
            <li>WinZip (pour supporter la compression et décompression)</li>
            <br>
