...
$word_requirements = 'ãÊØáÈÇÊ ÌíäÒæÑÇ';
$word_primary_settings = 'ÊÙÈíÊÇÊ ÑÁíÓíå';
$word_display_settings = 'ÇÙåÑ ÇáÊÙÈíÊÇÊ';
$word_verify_config = 'ÇßÏ ÇáäÙÈíÊáÊ';
$word_write_error = 'äÃÓÝ, áã äÊãßä ãä ÝÊÍ ãáÝ ÇáäÙÈíÊÇÊ<br><br>'
                                       . 'You can either do a copy and paste of the contents below<br><br>...or...<br><br>'
                                       . '<a href='
                                       . $href_path
                                       . '&action=save-config>ÇÖÛØ åäÇ</a> áÊÍãíá ãáÝ ÇáÊÙÈíÊÇÊ<br>'
                                       . '<a href='
                                       . $href_path
                                       . '&action=save-user>ÇÖÛØ åäÇ</a> to download the user database<br><br><br>'
                                       . 'Once complete <a href='
                                       . $href_path2
                                       . '>ÇÖÛØ åäÇ</a> áÊÝÚíá ÌíäÒæÇ';
$word_admin_username = 'ÇÓã ÇáÃÏãä:';
...
$word_admin_password = 'ÈÇÓæÑÏ ÇáÃÏãä:';
$word_web_root = 'ÇáÑæÊ';
...
$word_jinzora_directory = 'ãßÇä ÌíäÒæÑÇ';
$word_jinzora_directory_note = 'åÐÇ ãßÇä ÇáÝáÏÑ<br><br>';
$word_media_directory = 'ÇáãíÏíÇ:';
...
$word_media_directory_structure = 'åíÆå ÇáãíÏíÇ:';
...
$word_install_type = 'äæÚ ÇáÇäÓÊáÇÔä:';
...
$word_default_user_access = 'ÇáäæÚ ÇáÑÆíÓì:';
...
$word_primary_language = 'ÇááÛå ÇáÇÓÇÓíå:';
...
$word_allow_language_change = 'ÇÓãÍ ÈÊÛíÑ ÇááÛå:';
...
$word_disable_all_downloads = 'ÇãäÚ ÇáÊÍãíá:';
...
$word_download_type = 'ÊÍãíá ZIP Çæ MP3:';
...
$word_hide_when_found = 'ÚÏã ÇÙåÇÑ ÇáÊÑÇßÓ:';
...
$word_download_type = 'äæÚ ÇáÏÇæäáæÏ:';
...
$install_message = 'Please note that as you have not choosen Expert mode installation that the follow screens with be submitted automatically ' . 'for you using the defaults for the install type you have choosen.<br><br>Sit back and relax we will be done in just a second...';
...
$word_please_wait = 'ÇáÑÌÇÁ ÇáÇäÊÙÇÑ';
$word_agree = 'ãæÇÝÞ';
$word_must_agree = 'áÇÈÏ ÇáãæÇÝÞå';
