...
class getid3_riff
{
    public function __construct(&$fd, &$ThisFileInfo)
    {
        ...
        $RIFFsubtype = mb_substr($RIFFheader, 8, 4);

        switch (mb_substr($RIFFheader, 0, 4)) {
            case 'FORM':
                $ThisFileInfo['fileformat'] = 'aiff';
                $RIFFheaderSize = self::EitherEndian2Int($ThisFileInfo, mb_substr($RIFFheader, 4, 4));
                $thisfile_riff[$RIFFsubtype] = self::ParseRIFF($fd, $thisfile_avdataoffset + 12, $thisfile_avdataoffset + $RIFFheaderSize, $ThisFileInfo);
        ...
        switch ($RIFFsubtype) {
            case 'WAVE':
                ...
                if (isset($thisfile_riff_WAVE['fmt '][0]['data'])) {
                    ...
                    if (0 == @$thisfile_riff_audio[$streamindex]['bitrate']) {
                    ...
                    if ('unknown: 0x' == mb_substr($thisfile_audio['codec'], 0, mb_strlen('unknown: 0x'))) {
                ...
                if (isset($thisfile_riff_WAVE['rgad'][0]['data'])) {
                    ...
                    $thisfile_riff_raw_rgad['fPeakAmplitude'] = getid3_lib::LittleEndian2Float(mb_substr($rgadData, 0, 4));

                    $thisfile_riff_raw_rgad['nRadioRgAdjust'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($rgadData, 4, 2));

                    $thisfile_riff_raw_rgad['nAudiophileRgAdjust'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($rgadData, 6, 2));
                    ...
                    $thisfile_riff_raw_rgad_track['name'] = getid3_lib::Bin2Dec(mb_substr($nRadioRgAdjustBitstring, 0, 3));

                    $thisfile_riff_raw_rgad_track['originator'] = getid3_lib::Bin2Dec(mb_substr($nRadioRgAdjustBitstring, 3, 3));

                    $thisfile_riff_raw_rgad_track['signbit'] = getid3_lib::Bin2Dec(mb_substr($nRadioRgAdjustBitstring, 6, 1));

                    $thisfile_riff_raw_rgad_track['adjustment'] = getid3_lib::Bin2Dec(mb_substr($nRadioRgAdjustBitstring, 7, 9));

                    $thisfile_riff_raw_rgad_album['name'] = getid3_lib::Bin2Dec(mb_substr($nAudiophileRgAdjustBitstring, 0, 3));

                    $thisfile_riff_raw_rgad_album['originator'] = getid3_lib::Bin2Dec(mb_substr($nAudiophileRgAdjustBitstring, 3, 3));

                    $thisfile_riff_raw_rgad_album['signbit'] = getid3_lib::Bin2Dec(mb_substr($nAudiophileRgAdjustBitstring, 6, 1));

                    $thisfile_riff_raw_rgad_album['adjustment'] = getid3_lib::Bin2Dec(mb_substr($nAudiophileRgAdjustBitstring, 7, 9));

                    $thisfile_riff['rgad']['peakamplitude'] = $thisfile_riff_raw_rgad['fPeakAmplitude'];

                    if ((0 != $thisfile_riff_raw_rgad_track['name']) && (0 != $thisfile_riff_raw_rgad_track['originator'])) {
                    ...
                    if ((0 != $thisfile_riff_raw_rgad_album['name']) && (0 != $thisfile_riff_raw_rgad_album['originator'])) {
                ...
                if (isset($thisfile_riff_WAVE['fact'][0]['data'])) {
                    $thisfile_riff_raw['fact']['NumberOfSamples'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($thisfile_riff_WAVE['fact'][0]['data'], 0, 4));
                ...
                if (isset($thisfile_riff_WAVE['bext'][0]['data'])) {
                    ...
                    $thisfile_riff_WAVE_bext_0['title'] = trim(mb_substr($thisfile_riff_WAVE_bext_0['data'], 0, 256));

                    $thisfile_riff_WAVE_bext_0['author'] = trim(mb_substr($thisfile_riff_WAVE_bext_0['data'], 256, 32));

                    $thisfile_riff_WAVE_bext_0['reference'] = trim(mb_substr($thisfile_riff_WAVE_bext_0['data'], 288, 32));

                    $thisfile_riff_WAVE_bext_0['origin_date'] = mb_substr($thisfile_riff_WAVE_bext_0['data'], 320, 10);

                    $thisfile_riff_WAVE_bext_0['origin_time'] = mb_substr($thisfile_riff_WAVE_bext_0['data'], 330, 8);

                    $thisfile_riff_WAVE_bext_0['time_reference'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE_bext_0['data'], 338, 8));

                    $thisfile_riff_WAVE_bext_0['bwf_version'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE_bext_0['data'], 346, 1));

                    $thisfile_riff_WAVE_bext_0['reserved'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE_bext_0['data'], 347, 254));

                    $thisfile_riff_WAVE_bext_0['coding_history'] = explode("\r\n", trim(mb_substr($thisfile_riff_WAVE_bext_0['data'], 601)));

                    $thisfile_riff_WAVE_bext_0['origin_date_unix'] = mktime(
                        mb_substr($thisfile_riff_WAVE_bext_0['origin_time'], 0, 2),
                        mb_substr($thisfile_riff_WAVE_bext_0['origin_time'], 3, 2),
                        mb_substr($thisfile_riff_WAVE_bext_0['origin_time'], 6, 2),
                        mb_substr($thisfile_riff_WAVE_bext_0['origin_date'], 5, 2),
                        mb_substr($thisfile_riff_WAVE_bext_0['origin_date'], 8, 2),
                        mb_substr($thisfile_riff_WAVE_bext_0['origin_date'], 0, 4)
                    );
                ...
                if (isset($thisfile_riff_WAVE['MEXT'][0]['data'])) {
                    ...
                    $thisfile_riff_WAVE_MEXT_0['raw']['sound_information'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE_MEXT_0['data'], 0, 2));
                    ...
                    if ($thisfile_riff_WAVE_MEXT_0['flags']['homogenous']) {
                        ...
                        $thisfile_riff_WAVE_MEXT_0['nominal_frame_size'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE_MEXT_0['data'], 2, 2));
                    }

                    $thisfile_riff_WAVE_MEXT_0['anciliary_data_length'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE_MEXT_0['data'], 6, 2));

                    $thisfile_riff_WAVE_MEXT_0['raw']['anciliary_data_def'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE_MEXT_0['data'], 8, 2));
                ...
                if (isset($thisfile_riff_WAVE['cart'][0]['data'])) {
                    ...
                    $thisfile_riff_WAVE_cart_0['version'] = mb_substr($thisfile_riff_WAVE_cart_0['data'], 0, 4);

                    $thisfile_riff_WAVE_cart_0['title'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 4, 64));

                    $thisfile_riff_WAVE_cart_0['artist'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 68, 64));

                    $thisfile_riff_WAVE_cart_0['cut_id'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 132, 64));

                    $thisfile_riff_WAVE_cart_0['client_id'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 196, 64));

                    $thisfile_riff_WAVE_cart_0['category'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 260, 64));

                    $thisfile_riff_WAVE_cart_0['classification'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 324, 64));

                    $thisfile_riff_WAVE_cart_0['out_cue'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 388, 64));

                    $thisfile_riff_WAVE_cart_0['start_date'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 452, 10));

                    $thisfile_riff_WAVE_cart_0['start_time'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 462, 8));

                    $thisfile_riff_WAVE_cart_0['end_date'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 470, 10));

                    $thisfile_riff_WAVE_cart_0['end_time'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 480, 8));

                    $thisfile_riff_WAVE_cart_0['producer_app_id'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 488, 64));

                    $thisfile_riff_WAVE_cart_0['producer_app_version'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 552, 64));

                    $thisfile_riff_WAVE_cart_0['user_defined_text'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 616, 64));

                    $thisfile_riff_WAVE_cart_0['zero_db_reference'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE_cart_0['data'], 680, 4), true);

                    for ($i = 0; $i < 8; $i++) {
                        $thisfile_riff_WAVE_cart_0['post_time'][$i]['usage_fourcc'] = mb_substr($thisfile_riff_WAVE_cart_0['data'], 684 + ($i * 8), 4);

                        $thisfile_riff_WAVE_cart_0['post_time'][$i]['timer_value'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE_cart_0['data'], 684 + ($i * 8) + 4, 4));
                    }

                    $thisfile_riff_WAVE_cart_0['url'] = trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 748, 1024));

                    $thisfile_riff_WAVE_cart_0['tag_text'] = explode("\r\n", trim(mb_substr($thisfile_riff_WAVE_cart_0['data'], 1772)));
                ...
                if (!empty($ThisFileInfo['wavpack'])) {
                    ...
                    self::ParseRIFFdata($RIFFdata, $ThisFileInfo);
                }
                ...
                if (isset($thisfile_riff_raw['fmt ']['wFormatTag'])) {
                    switch ($thisfile_riff_raw['fmt ']['wFormatTag']) {
                        case 0x08AE: // ClearJump LiteWave
                            ...
                            $thisfile_riff_litewave_raw['compression_method'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE['fmt '][0]['data'], 18, 1));
                            $thisfile_riff_litewave_raw['compression_flags'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE['fmt '][0]['data'], 19, 1));
                            $thisfile_riff_litewave_raw['m_dwScale'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE['fmt '][0]['data'], 20, 4));
                            $thisfile_riff_litewave_raw['m_dwBlockSize'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE['fmt '][0]['data'], 24, 4));
                            $thisfile_riff_litewave_raw['m_wQuality'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE['fmt '][0]['data'], 28, 2));
                            $thisfile_riff_litewave_raw['m_wMarkDistance'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE['fmt '][0]['data'], 30, 2));
                            $thisfile_riff_litewave_raw['m_wReserved'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE['fmt '][0]['data'], 32, 2));
                            $thisfile_riff_litewave_raw['m_dwOrgSize'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE['fmt '][0]['data'], 34, 4));
                            $thisfile_riff_litewave_raw['m_bFactExists'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE['fmt '][0]['data'], 38, 2));
                            $thisfile_riff_litewave_raw['m_dwRiffChunkSize'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_riff_WAVE['fmt '][0]['data'], 40, 4));
                            ...
                            $thisfile_audio['lossless'] = ((100 == $thisfile_riff_litewave_raw['m_wQuality']) ? true : false);
                ...
                if ($thisfile_avdataend > $ThisFileInfo['filesize']) {
                    switch (@$thisfile_audio_dataformat) {
                        ...
                        case 'ofs':     // OptimFROG DualStream
                            ...
                            break;
                        case 'litewave':
                            if (1 == ($thisfile_avdataend - $ThisFileInfo['filesize'])) {
                                ...
                                $ThisFileInfo['warning'][] = 'Probably truncated file - expecting '
                                                             . $thisfile_riff[$RIFFsubtype]['data'][0]['size']
                                                             . ' bytes of data, only found '
                                                             . ($ThisFileInfo['filesize'] - $thisfile_avdataoffset)
                                                             . ' (short by '
                                                             . ($thisfile_riff[$RIFFsubtype]['data'][0]['size'] - ($ThisFileInfo['filesize'] - $thisfile_avdataoffset))
                                                             . ' bytes)';
                            ...
                            break;
                        default:
                            if ((1 == ($thisfile_avdataend - $ThisFileInfo['filesize'])) && (0 == ($thisfile_riff[$RIFFsubtype]['data'][0]['size'] % 2)) && (1 == (($ThisFileInfo['filesize'] - $thisfile_avdataoffset) % 2))) {
                                // output file appears to be incorrectly *not* padded to nearest WORD boundary

                                // Output less severe warning

                                $ThisFileInfo['warning'][] = 'File should probably be padded to nearest WORD boundary, but it is not (expecting '
                                                             . $thisfile_riff[$RIFFsubtype]['data'][0]['size']
                                                             . ' bytes of data, only found '
                                                             . ($ThisFileInfo['filesize'] - $thisfile_avdataoffset)
                                                             . ' therefore short by '
                            ...
                            // Short by more than one byte, throw warning
                            $ThisFileInfo['warning'][] = 'Probably truncated file - expecting ' . $thisfile_riff[$RIFFsubtype]['data'][0]['size'] . ' bytes of data, only found ' . ($ThisFileInfo['filesize'] - $thisfile_avdataoffset) . ' (short by ' . ($thisfile_riff[$RIFFsubtype]['data'][0]['size']
                                                                                                                                                                                                                                                            - ($ThisFileInfo['filesize']
                                                                                                                                                                                                                                                               - $thisfile_avdataoffset)) . ' bytes)';
                            $thisfile_avdataend = $ThisFileInfo['filesize'];
                            break;
                    }
                }
                if (!empty($ThisFileInfo['mpeg']['audio']['LAME']['audio_bytes'])) {
                    if (1 == (($thisfile_avdataend - $thisfile_avdataoffset) - $ThisFileInfo['mpeg']['audio']['LAME']['audio_bytes'])) {
                        $thisfile_avdataend--;

                        $ThisFileInfo['warning'][] = 'Extra null byte at end of MP3 data assumed to be RIFF padding and therefore ignored';
                    }
                }
                if ('ac3' == @$thisfile_audio_dataformat) {
            ...
            case 'AVI ':
                ...
                if (isset($thisfile_riff[$RIFFsubtype]['movi']['offset'])) {
                    ...
                    if ($thisfile_avdataend > $ThisFileInfo['filesize']) {
                        $ThisFileInfo['warning'][] = 'Probably truncated file - expecting '
                                                     . $thisfile_riff[$RIFFsubtype]['movi']['size']
                                                     . ' bytes of data, only found '
                                                     . ($ThisFileInfo['filesize'] - $thisfile_avdataoffset)
                                                     . ' (short by '
                                                     . ($thisfile_riff[$RIFFsubtype]['movi']['size']
                ...
                if (isset($thisfile_riff['AVI ']['hdrl']['avih'][$streamindex]['data'])) {
                    ...
                    $thisfile_riff_raw_avih['dwMicroSecPerFrame'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 0, 4)); // frame display rate (or 0L)

                    if (0 == $thisfile_riff_raw_avih['dwMicroSecPerFrame']) {
                        $ThisFileInfo['error'][] = 'Corrupt RIFF file: avih.dwMicroSecPerFrame == zero';

                        return false;
                    }

                    $thisfile_riff_raw_avih['dwMaxBytesPerSec'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 4, 4)); // max. transfer rate
                    $thisfile_riff_raw_avih['dwPaddingGranularity'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 8, 4)); // pad to multiples of this size; normally 2K.
                    $thisfile_riff_raw_avih['dwFlags'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 12, 4)); // the ever-present flags
                    $thisfile_riff_raw_avih['dwTotalFrames'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 16, 4)); // # frames in file
                    $thisfile_riff_raw_avih['dwInitialFrames'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 20, 4));

                    $thisfile_riff_raw_avih['dwStreams'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 24, 4));

                    $thisfile_riff_raw_avih['dwSuggestedBufferSize'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 28, 4));

                    $thisfile_riff_raw_avih['dwWidth'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 32, 4));

                    $thisfile_riff_raw_avih['dwHeight'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 36, 4));

                    $thisfile_riff_raw_avih['dwScale'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 40, 4));

                    $thisfile_riff_raw_avih['dwRate'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 44, 4));

                    $thisfile_riff_raw_avih['dwStart'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 48, 4));

                    $thisfile_riff_raw_avih['dwLength'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($avihData, 52, 4));
                    ...
                    if (is_array($thisfile_riff['AVI ']['hdrl']['strl']['strh'])) {
                        for ($i = 0, $iMax = count($thisfile_riff['AVI ']['hdrl']['strl']['strh']); $i < $iMax; $i++) {
                            if (isset($thisfile_riff['AVI ']['hdrl']['strl']['strh'][$i]['data'])) {
                                ...
                                $strhfccType = mb_substr($strhData, 0, 4);
                                ...
                                if (isset($thisfile_riff['AVI ']['hdrl']['strl']['strf'][$i]['data'])) {
                                    ...
                                    switch ($strhfccType) {
                                        case 'auds':
                                            ...
                                            if (0 == $thisfile_audio_streams_currentstream['bits_per_sample']) {
                                        ...
                                        case 'vids':
                                            ...
                                            $thisfile_riff_raw_strh_current['fccType'] = mb_substr($strhData, 0, 4);  // same as $strhfccType;
                                            $thisfile_riff_raw_strh_current['fccHandler'] = mb_substr($strhData, 4, 4);
                                            $thisfile_riff_raw_strh_current['dwFlags'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 8, 4)); // Contains AVITF_* flags
                                            $thisfile_riff_raw_strh_current['wPriority'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 12, 2));
                                            $thisfile_riff_raw_strh_current['wLanguage'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 14, 2));
                                            $thisfile_riff_raw_strh_current['dwInitialFrames'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 16, 4));
                                            $thisfile_riff_raw_strh_current['dwScale'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 20, 4));
                                            $thisfile_riff_raw_strh_current['dwRate'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 24, 4));
                                            $thisfile_riff_raw_strh_current['dwStart'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 28, 4));
                                            $thisfile_riff_raw_strh_current['dwLength'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 32, 4));
                                            $thisfile_riff_raw_strh_current['dwSuggestedBufferSize'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 36, 4));
                                            $thisfile_riff_raw_strh_current['dwQuality'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 40, 4));
                                            $thisfile_riff_raw_strh_current['dwSampleSize'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 44, 4));
                                            $thisfile_riff_raw_strh_current['rcFrame'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strhData, 48, 4));
                                            ...
                                            switch ($strhfccType) {
                                                case 'vids':
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['biSize'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strfData, 0, 4)); // number of bytes required by the BITMAPINFOHEADER structure
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['biWidth'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strfData, 4, 4)); // width of the bitmap in pixels
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['biHeight'] = self::EitherEndian2Int(
                                                        $ThisFileInfo,
                                                        mb_substr($strfData, 8, 4)
                                                    ...
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['biPlanes'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strfData, 12, 2)); // number of color planes on the target device. In most cases this value must be set to 1
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['biBitCount'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strfData, 14, 2)); // Specifies the number of bits per pixels
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['fourcc'] = mb_substr($strfData, 16, 4);  
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['biSizeImage'] = self::EitherEndian2Int(
                                                        $ThisFileInfo,
                                                        mb_substr($strfData, 20, 4)
                                                    ); // size of the bitmap data section of the image (the actual pixel data, excluding BITMAPINFOHEADER and RGBQUAD structures)
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['biXPelsPerMeter'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strfData, 24, 4)); // horizontal resolution, in pixels per metre, of the target device
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['biYPelsPerMeter'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($strfData, 28, 4)); // vertical resolution, in pixels per metre, of the target device
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['biClrUsed'] = self::EitherEndian2Int(
                                                        $ThisFileInfo,
                                                        mb_substr($strfData, 32, 4)
                                                    ...
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex['biClrImportant'] = self::EitherEndian2Int(
                                                        $ThisFileInfo,
                                                        mb_substr($strfData, 36, 4)
                                                    ...
                                                    if ('DV' == $thisfile_riff_video_current['codec']) {
                            ...
                            if (isset($thisfile_riff_raw_strf_strhfccType_streamindex['fourcc']) && self::RIFFfourccLookup($thisfile_riff_raw_strf_strhfccType_streamindex['fourcc'])) {
                                $thisfile_riff_video_current['codec'] = self::RIFFfourccLookup($thisfile_riff_raw_strf_strhfccType_streamindex['fourcc']);
            ...
            case 'CDDA':
                ...
                if (isset($thisfile_riff['CDDA']['fmt '][0]['data'])) {
                    ...
                    $thisfile_riff_CDDA_fmt_0['unknown1'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($thisfile_riff_CDDA_fmt_0['data'], 0, 2));

                    $thisfile_riff_CDDA_fmt_0['track_num'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($thisfile_riff_CDDA_fmt_0['data'], 2, 2));

                    $thisfile_riff_CDDA_fmt_0['disc_id'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($thisfile_riff_CDDA_fmt_0['data'], 4, 4));

                    $thisfile_riff_CDDA_fmt_0['start_offset_frame'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($thisfile_riff_CDDA_fmt_0['data'], 8, 4));

                    $thisfile_riff_CDDA_fmt_0['playtime_frames'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($thisfile_riff_CDDA_fmt_0['data'], 12, 4));

                    $thisfile_riff_CDDA_fmt_0['unknown6'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($thisfile_riff_CDDA_fmt_0['data'], 16, 4));

                    $thisfile_riff_CDDA_fmt_0['unknown7'] = self::EitherEndian2Int($ThisFileInfo, mb_substr($thisfile_riff_CDDA_fmt_0['data'], 20, 4));
            ...
            case 'AIFC':
                ...
                if (isset($thisfile_riff[$RIFFsubtype]['SSND'][0]['offset'])) {
                    ...
                    if ($thisfile_avdataend > $ThisFileInfo['filesize']) {
                        if ((($ThisFileInfo['filesize'] + 1) == $thisfile_avdataend) && (($ThisFileInfo['filesize'] % 2) == 1)) {
                ...
                if (isset($thisfile_riff[$RIFFsubtype]['COMM'][0]['data'])) {
                    ...
                    $thisfile_riff_audio['channels'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff_RIFFsubtype_COMM_0_data, 0, 2), true);

                    $thisfile_riff_audio['total_samples'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff_RIFFsubtype_COMM_0_data, 2, 4), false);

                    $thisfile_riff_audio['bits_per_sample'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff_RIFFsubtype_COMM_0_data, 6, 2), true);

                    $thisfile_riff_audio['sample_rate'] = (int)getid3_lib::BigEndian2Float(mb_substr($thisfile_riff_RIFFsubtype_COMM_0_data, 8, 10));

                    if ($thisfile_riff[$RIFFsubtype]['COMM'][0]['size'] > 18) {
                        $thisfile_riff_audio['codec_fourcc'] = mb_substr($thisfile_riff_RIFFsubtype_COMM_0_data, 18, 4);

                        $CodecNameSize = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff_RIFFsubtype_COMM_0_data, 22, 1), false);

                        $thisfile_riff_audio['codec_name'] = mb_substr($thisfile_riff_RIFFsubtype_COMM_0_data, 23, $CodecNameSize);
                    ...
                    if (0 == $thisfile_audio['sample_rate']) {
                ...
                if (isset($thisfile_riff[$RIFFsubtype]['COMT'])) {
                    ...
                    $CommentCount = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff[$RIFFsubtype]['COMT'][0]['data'], $offset, 2), false);

                    $offset += 2;

                    for ($i = 0; $i < $CommentCount; $i++) {
                        $ThisFileInfo['comments_raw'][$i]['timestamp'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff[$RIFFsubtype]['COMT'][0]['data'], $offset, 4), false);

                        $offset += 4;

                        $ThisFileInfo['comments_raw'][$i]['marker_id'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff[$RIFFsubtype]['COMT'][0]['data'], $offset, 2), true);

                        $offset += 2;

                        $CommentLength = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff[$RIFFsubtype]['COMT'][0]['data'], $offset, 2), false);

                        $offset += 2;

                        $ThisFileInfo['comments_raw'][$i]['comment'] = mb_substr($thisfile_riff[$RIFFsubtype]['COMT'][0]['data'], $offset, $CommentLength);
            ...
            case '8SVX':
                ...
                if (isset($thisfile_riff[$RIFFsubtype]['VHDR'][0]['offset'])) {
                    ...
                    $thisfile_riff_RIFFsubtype_VHDR_0['oneShotHiSamples'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff_RIFFsubtype_VHDR_0['data'], 0, 4));

                    $thisfile_riff_RIFFsubtype_VHDR_0['repeatHiSamples'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff_RIFFsubtype_VHDR_0['data'], 4, 4));

                    $thisfile_riff_RIFFsubtype_VHDR_0['samplesPerHiCycle'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff_RIFFsubtype_VHDR_0['data'], 8, 4));

                    $thisfile_riff_RIFFsubtype_VHDR_0['samplesPerSec'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff_RIFFsubtype_VHDR_0['data'], 12, 2));

                    $thisfile_riff_RIFFsubtype_VHDR_0['ctOctave'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff_RIFFsubtype_VHDR_0['data'], 14, 1));

                    $thisfile_riff_RIFFsubtype_VHDR_0['sCompression'] = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff_RIFFsubtype_VHDR_0['data'], 15, 1));

                    $thisfile_riff_RIFFsubtype_VHDR_0['Volume'] = getid3_lib::FixedPoint16_16(mb_substr($thisfile_riff_RIFFsubtype_VHDR_0['data'], 16, 4));
                ...
                if (isset($thisfile_riff[$RIFFsubtype]['CHAN'][0]['data'])) {
                    $ChannelsIndex = getid3_lib::BigEndian2Int(mb_substr($thisfile_riff[$RIFFsubtype]['CHAN'][0]['data'], 0, 4));
        ...
        if (isset($thisfile_riff_WAVE['DISP']) && is_array($thisfile_riff_WAVE['DISP'])) {
            $thisfile_riff['comments']['title'][] = trim(mb_substr($thisfile_riff_WAVE['DISP'][count($thisfile_riff_WAVE['DISP']) - 1]['data'], 4));
        }
        ...
        if (isset($ThisFileInfo['mpeg']['audio'])) {
            ...
            $thisfile_audio['bitrate_mode'] = mb_strtolower($ThisFileInfo['mpeg']['audio']['bitrate_mode']);
    ...
    public function ParseRIFF(&$fd, $startoffset, $maxoffset, &$ThisFileInfo)
    {
        ...
        while (ftell($fd) < $maxoffset) {
            ...
            $chunksize = self::EitherEndian2Int($ThisFileInfo, fread($fd, 4));
                    ...
                    switch ($listname) {
                        ...
                        case 'rec ':
                            ...
                            if ($ParsedAudioStream) {
                                ...
                                $AudioChunkStreamNum = mb_substr($AudioChunkHeader, 0, 2);

                                $AudioChunkStreamType = mb_substr($AudioChunkHeader, 2, 2);

                                $AudioChunkSize = getid3_lib::LittleEndian2Int(mb_substr($AudioChunkHeader, 4, 4));

                                if ('wb' == $AudioChunkStreamType) {
                                    $FirstFourBytes = mb_substr($AudioChunkHeader, 8, 4);
                                    ...
                                    if (preg_match('/^\xFF[\xE2-\xE7\xF2-\xF7\xFA-\xFF][\x00-\xEB]/s', $FirstFourBytes)) {
                                        ...
                                        if (getid3_mp3::MPEGaudioHeaderBytesValid($FirstFourBytes)) {
                                            ...
                                            if (isset($dummy['mpeg']['audio'])) {
                                                ...
                                                $ThisFileInfo['audio']['bitrate_mode'] = mb_strtolower($ThisFileInfo['mpeg']['audio']['bitrate_mode']);
                                            }
                                        }
                        ...
                        default:
                            ...
                            $RIFFchunk[$listname] = array_merge_recursive($RIFFchunk[$listname], self::ParseRIFF($fd, ftell($fd), ftell($fd) + $chunksize - 4, $ThisFileInfo));
                            break;
                    }
                    break;
                default:
                    ...
                    switch ($chunkname) {
                        case 'data':
                            ...
                            if ((mb_strlen($RIFFdataChunkContentsTest) > 0) && preg_match('/^\xFF[\xE2-\xE7\xF2-\xF7\xFA-\xFF][\x00-\xEB]/s', mb_substr($RIFFdataChunkContentsTest, 0, 4))) {
                                // Probably is MP3 data

                                if (getid3_mp3::MPEGaudioHeaderBytesValid(mb_substr($RIFFdataChunkContentsTest, 0, 4))) {
                                    getid3_mp3::getOnlyMPEGaudioInfo($fd, $ThisFileInfo, $RIFFchunk[$chunkname][$thisindex]['offset'], false);
                                }
                            } elseif ((mb_strlen($RIFFdataChunkContentsTest) > 0) && ("\x0B\x77" == mb_substr($RIFFdataChunkContentsTest, 0, 2))) {
                            ...
                            } elseif ((mb_strlen($RIFFdataChunkContentsTest) > 0) && ("\x77\x0B" == mb_substr($RIFFdataChunkContentsTest, 8, 2))) {
                                // Dolby Digital WAV
                                ...
                                if (getid3_lib::IncludeDependency(GETID3_INCLUDEPATH . 'module.audio.ac3.php', __FILE__, false)) {
                                    if ($fd_temp = tmpfile()) {
                                        for ($i = 0; $i < 28; $i += 2) {
                                            ...
                                            fwrite($fd_temp, mb_substr($RIFFdataChunkContentsTest, 8 + $i + 1, 1));

                                            fwrite($fd_temp, mb_substr($RIFFdataChunkContentsTest, 8 + $i + 0, 1));
                                        }
                            ...
                            } elseif ((mb_strlen($RIFFdataChunkContentsTest) > 0) && ('wvpk' == mb_substr($RIFFdataChunkContentsTest, 0, 4))) {
                                // This is WavPack data

                                $ThisFileInfo['wavpack']['offset'] = $RIFFchunk[$chunkname][$thisindex]['offset'];

                                $ThisFileInfo['wavpack']['size'] = getid3_lib::LittleEndian2Int(mb_substr($RIFFdataChunkContentsTest, 4, 4));

                                self::RIFFparseWavPackHeader(mb_substr($RIFFdataChunkContentsTest, 8, 22), $ThisFileInfo);
                            }  
    ...
    public function ParseRIFFdata(&$RIFFdata, &$ThisFileInfo)
    {
        if ($RIFFdata) {
            if ($fp_temp = tmpfile()) {
                $RIFFdataLength = mb_strlen($RIFFdata);
                ...
                $dummy = [
                    ...
                    'audio' => ($ThisFileInfo['audio'] ?? []),
                    'video' => ($ThisFileInfo['video'] ?? []),
                ];

                $riff = new self($fp_temp, $dummy);
    ...
    public function RIFFparseWAVEFORMATex($WaveFormatExData)
    {
        // shortcut
        ...
        $WaveFormatEx_raw['wFormatTag'] = getid3_lib::LittleEndian2Int(mb_substr($WaveFormatExData, 0, 2));

        $WaveFormatEx_raw['nChannels'] = getid3_lib::LittleEndian2Int(mb_substr($WaveFormatExData, 2, 2));

        $WaveFormatEx_raw['nSamplesPerSec'] = getid3_lib::LittleEndian2Int(mb_substr($WaveFormatExData, 4, 4));

        $WaveFormatEx_raw['nAvgBytesPerSec'] = getid3_lib::LittleEndian2Int(mb_substr($WaveFormatExData, 8, 4));

        $WaveFormatEx_raw['nBlockAlign'] = getid3_lib::LittleEndian2Int(mb_substr($WaveFormatExData, 12, 2));

        $WaveFormatEx_raw['wBitsPerSample'] = getid3_lib::LittleEndian2Int(mb_substr($WaveFormatExData, 14, 2));

        if (mb_strlen($WaveFormatExData) > 16) {
            $WaveFormatEx_raw['cbSize'] = getid3_lib::LittleEndian2Int(mb_substr($WaveFormatExData, 16, 2));
        }
    ...
    public function RIFFparseWavPackHeader($WavPackChunkData, &$ThisFileInfo)
    {
        // typedef struct {
        ...
        $thisfile_wavpack['version'] = getid3_lib::LittleEndian2Int(mb_substr($WavPackChunkData, 0, 2));

        if ($thisfile_wavpack['version'] >= 2) {
            $thisfile_wavpack['bits'] = getid3_lib::LittleEndian2Int(mb_substr($WavPackChunkData, 2, 2));
        }

        if ($thisfile_wavpack['version'] >= 3) {
            $thisfile_wavpack['flags_raw'] = getid3_lib::LittleEndian2Int(mb_substr($WavPackChunkData, 4, 2));

            $thisfile_wavpack['shift'] = getid3_lib::LittleEndian2Int(mb_substr($WavPackChunkData, 6, 2));

            $thisfile_wavpack['total_samples'] = getid3_lib::LittleEndian2Int(mb_substr($WavPackChunkData, 8, 4));

            $thisfile_wavpack['crc1'] = getid3_lib::LittleEndian2Int(mb_substr($WavPackChunkData, 12, 4));

            $thisfile_wavpack['crc2'] = getid3_lib::LittleEndian2Int(mb_substr($WavPackChunkData, 16, 4));

            $thisfile_wavpack['extension'] = mb_substr($WavPackChunkData, 20, 4);

            $thisfile_wavpack['extra_bc'] = getid3_lib::LittleEndian2Int(mb_substr($WavPackChunkData, 24, 1));

            for ($i = 0; $i < 3; $i++) {
                $thisfile_wavpack['extras'][] = getid3_lib::LittleEndian2Int(mb_substr($WavPackChunkData, 25 + $i, 1));
            }
    ...
    public function RIFFwFormatTagLookup($wFormatTag)
    {
        $begin = __LINE__;
        ...
        return getid3_lib::EmbeddedLookup('0x' . str_pad(mb_strtoupper(dechex($wFormatTag)), 4, '0', STR_PAD_LEFT), $begin, __LINE__, __FILE__, 'riff-wFormatTag');
    }

    public function RIFFfourccLookup($fourcc)
    {
        $begin = __LINE__;
    ...
    public function EitherEndian2Int($ThisFileInfo, $byteword, $signed = false)
    {
        if ('riff' == $ThisFileInfo['fileformat']) {
