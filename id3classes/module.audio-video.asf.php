...
class getid3_asf
{
    public function __construct($fd, &$ThisFileInfo)
    {
        ...
        $thisfile_asf_headerobject['objectid'] = mb_substr($HeaderObjectData, 0, 16);

        $thisfile_asf_headerobject['objectid_guid'] = $this->BytestringToGUID($thisfile_asf_headerobject['objectid']);

        if (GETID3_ASF_Header_Object != $thisfile_asf_headerobject['objectid']) {
        ...
        $thisfile_asf_headerobject['objectsize'] = getid3_lib::LittleEndian2Int(mb_substr($HeaderObjectData, 16, 8));

        $thisfile_asf_headerobject['headerobjects'] = getid3_lib::LittleEndian2Int(mb_substr($HeaderObjectData, 24, 4));

        $thisfile_asf_headerobject['reserved1'] = getid3_lib::LittleEndian2Int(mb_substr($HeaderObjectData, 28, 1));

        $thisfile_asf_headerobject['reserved2'] = getid3_lib::LittleEndian2Int(mb_substr($HeaderObjectData, 29, 1));
        ...
        for ($HeaderObjectsCounter = 0; $HeaderObjectsCounter < $thisfile_asf_headerobject['headerobjects']; $HeaderObjectsCounter++) {
            $NextObjectGUID = mb_substr($ASFHeaderData, $offset, 16);

            $offset += 16;

            $NextObjectGUIDtext = $this->BytestringToGUID($NextObjectGUID);

            $NextObjectSize = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 8));
            ...
            switch ($NextObjectGUID) {
                case GETID3_ASF_File_Properties_Object:
                    ...
                    $thisfile_asf_filepropertiesobject['fileid'] = mb_substr($ASFHeaderData, $offset, 16);
                    $offset += 16;
                    $thisfile_asf_filepropertiesobject['fileid_guid'] = $this->BytestringToGUID($thisfile_asf_filepropertiesobject['fileid']);
                    $thisfile_asf_filepropertiesobject['filesize'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 8));
                    $offset += 8;
                    $thisfile_asf_filepropertiesobject['creation_date'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 8));
                    ...
                    $offset += 8;
                    $thisfile_asf_filepropertiesobject['data_packets'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 8));
                    $offset += 8;
                    $thisfile_asf_filepropertiesobject['play_duration'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 8));
                    $offset += 8;
                    $thisfile_asf_filepropertiesobject['send_duration'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 8));
                    $offset += 8;
                    $thisfile_asf_filepropertiesobject['preroll'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 8));
                    $offset += 8;
                    ...
                    $thisfile_asf_filepropertiesobject['flags_raw'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                    $offset += 4;
                    ...
                    $thisfile_asf_filepropertiesobject['min_packet_size'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                    $offset += 4;
                    $thisfile_asf_filepropertiesobject['max_packet_size'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                    $offset += 4;
                    $thisfile_asf_filepropertiesobject['max_bitrate'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                    $offset += 4;
                ...
                case GETID3_ASF_Stream_Properties_Object:
                    ...
                    $StreamPropertiesObjectData['stream_type'] = mb_substr($ASFHeaderData, $offset, 16);
                    $offset += 16;
                    $StreamPropertiesObjectData['stream_type_guid'] = $this->BytestringToGUID($StreamPropertiesObjectData['stream_type']);
                    $StreamPropertiesObjectData['error_correct_type'] = mb_substr($ASFHeaderData, $offset, 16);
                    $offset += 16;
                    $StreamPropertiesObjectData['error_correct_guid'] = $this->BytestringToGUID($StreamPropertiesObjectData['error_correct_type']);
                    $StreamPropertiesObjectData['time_offset'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 8));
                    $offset += 8;
                    $StreamPropertiesObjectData['type_data_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                    $offset += 4;
                    $StreamPropertiesObjectData['error_data_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                    $offset += 4;
                    $StreamPropertiesObjectData['flags_raw'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    ...
                    $StreamPropertiesObjectData['type_specific_data'] = mb_substr($ASFHeaderData, $offset, $StreamPropertiesObjectData['type_data_length']);
                    $offset += $StreamPropertiesObjectData['type_data_length'];
                    $StreamPropertiesObjectData['error_correct_data'] = mb_substr($ASFHeaderData, $offset, $StreamPropertiesObjectData['error_data_length']);
                    ...
                    switch ($StreamPropertiesObjectData['stream_type']) {
                        case GETID3_ASF_Audio_Media:
                            ...
                            $audiodata = getid3_riff::RIFFparseWAVEFORMATex(mb_substr($StreamPropertiesObjectData['type_specific_data'], 0, 16));
                            unset($audiodata['raw']);
                ...
                case GETID3_ASF_Header_Extension_Object:
                    ...
                    $thisfile_asf_headerextensionobject['reserved_1'] = mb_substr($ASFHeaderData, $offset, 16);
                    $offset += 16;
                    $thisfile_asf_headerextensionobject['reserved_1_guid'] = $this->BytestringToGUID($thisfile_asf_headerextensionobject['reserved_1']);
                    if (GETID3_ASF_Reserved_1 != $thisfile_asf_headerextensionobject['reserved_1']) {
                    ...
                    $thisfile_asf_headerextensionobject['reserved_2'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    if (6 != $thisfile_asf_headerextensionobject['reserved_2']) {
                    ...
                    $thisfile_asf_headerextensionobject['extension_data_size'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                    $offset += 4;
                    $thisfile_asf_headerextensionobject['extension_data'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_headerextensionobject['extension_data_size']);
                ...
                case GETID3_ASF_Codec_List_Object:
                    ...
                    $thisfile_asf_codeclistobject['reserved'] = mb_substr($ASFHeaderData, $offset, 16);
                    $offset += 16;
                    ...
                    $thisfile_asf_codeclistobject['codec_entries_count'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                    $offset += 4;
                    for ($CodecEntryCounter = 0; $CodecEntryCounter < $thisfile_asf_codeclistobject['codec_entries_count']; $CodecEntryCounter++) {
                        ...
                        $thisfile_asf_codeclistobject_codecentries_current['type_raw'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                        ...
                        $CodecNameLength = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2)) * 2; // 2 bytes per character

                        $offset += 2;

                        $thisfile_asf_codeclistobject_codecentries_current['name'] = mb_substr($ASFHeaderData, $offset, $CodecNameLength);

                        $offset += $CodecNameLength;

                        $CodecDescriptionLength = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2)) * 2; // 2 bytes per character

                        $offset += 2;

                        $thisfile_asf_codeclistobject_codecentries_current['description'] = mb_substr($ASFHeaderData, $offset, $CodecDescriptionLength);

                        $offset += $CodecDescriptionLength;

                        $CodecInformationLength = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));

                        $offset += 2;

                        $thisfile_asf_codeclistobject_codecentries_current['information'] = mb_substr($ASFHeaderData, $offset, $CodecInformationLength);

                        $offset += $CodecInformationLength;

                        if (2 == $thisfile_asf_codeclistobject_codecentries_current['type_raw']) {
                            // audio codec
                            ...
                            if (!isset($thisfile_audio['bitrate']) && mb_strstr($AudioCodecBitrate, 'kbps')) {
                            ...
                            if (!isset($thisfile_audio['channels'])) {
                                if (mb_strstr($AudioCodecChannels, 'stereo')) {
                                    $thisfile_audio['channels'] = 2;
                                } elseif (mb_strstr($AudioCodecChannels, 'mono')) {
                ...
                case GETID3_ASF_Script_Command_Object:
                    ...
                    $thisfile_asf_scriptcommandobject['reserved'] = mb_substr($ASFHeaderData, $offset, 16);
                    $offset += 16;
                    ...
                    $thisfile_asf_scriptcommandobject['commands_count'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    $thisfile_asf_scriptcommandobject['command_types_count'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    for ($CommandTypesCounter = 0; $CommandTypesCounter < $thisfile_asf_scriptcommandobject['command_types_count']; $CommandTypesCounter++) {
                        $CommandTypeNameLength = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2)) * 2; // 2 bytes per character

                        $offset += 2;

                        $thisfile_asf_scriptcommandobject['command_types'][$CommandTypesCounter]['name'] = mb_substr($ASFHeaderData, $offset, $CommandTypeNameLength);
                    ...
                    for ($CommandsCounter = 0; $CommandsCounter < $thisfile_asf_scriptcommandobject['commands_count']; $CommandsCounter++) {
                        $thisfile_asf_scriptcommandobject['commands'][$CommandsCounter]['presentation_time'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));

                        $offset += 4;

                        $thisfile_asf_scriptcommandobject['commands'][$CommandsCounter]['type_index'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                        ...
                        $thisfile_asf_scriptcommandobject['commands'][$CommandsCounter]['name'] = mb_substr($ASFHeaderData, $offset, $CommandTypeNameLength);
                ...
                case GETID3_ASF_Marker_Object:
                    ...
                    $thisfile_asf_markerobject['reserved'] = mb_substr($ASFHeaderData, $offset, 16);
                    $offset += 16;
                    ...
                    $thisfile_asf_markerobject['markers_count'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                    $offset += 4;
                    $thisfile_asf_markerobject['reserved_2'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    if (0 != $thisfile_asf_markerobject['reserved_2']) {
                    ...
                    $thisfile_asf_markerobject['name_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    $thisfile_asf_markerobject['name'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_markerobject['name_length']);
                    ...
                    for ($MarkersCounter = 0; $MarkersCounter < $thisfile_asf_markerobject['markers_count']; $MarkersCounter++) {
                        $thisfile_asf_markerobject['markers'][$MarkersCounter]['offset'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 8));

                        $offset += 8;

                        $thisfile_asf_markerobject['markers'][$MarkersCounter]['presentation_time'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 8));

                        $offset += 8;

                        $thisfile_asf_markerobject['markers'][$MarkersCounter]['entry_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));

                        $offset += 2;

                        $thisfile_asf_markerobject['markers'][$MarkersCounter]['send_time'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));

                        $offset += 4;

                        $thisfile_asf_markerobject['markers'][$MarkersCounter]['flags'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));

                        $offset += 4;

                        $thisfile_asf_markerobject['markers'][$MarkersCounter]['marker_description_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));

                        $offset += 4;

                        $thisfile_asf_markerobject['markers'][$MarkersCounter]['marker_description'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_markerobject['markers'][$MarkersCounter]['marker_description_length']);
                        ...
                        if ($PaddingLength > 0) {
                            $thisfile_asf_markerobject['markers'][$MarkersCounter]['padding'] = mb_substr($ASFHeaderData, $offset, $PaddingLength);
                ...
                case GETID3_ASF_Bitrate_Mutual_Exclusion_Object:
                    ...
                    $thisfile_asf_bitratemutualexclusionobject['reserved'] = mb_substr($ASFHeaderData, $offset, 16);
                    ...
                    $offset += 16;
                    if ((GETID3_ASF_Mutex_Bitrate != $thisfile_asf_bitratemutualexclusionobject['reserved']) && (GETID3_ASF_Mutex_Unknown != $thisfile_asf_bitratemutualexclusionobject['reserved'])) {
                        $ThisFileInfo['warning'][] = 'bitrate_mutual_exclusion_object.reserved GUID {'
                    ...
                    $thisfile_asf_bitratemutualexclusionobject['stream_numbers_count'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    for ($StreamNumberCounter = 0; $StreamNumberCounter < $thisfile_asf_bitratemutualexclusionobject['stream_numbers_count']; $StreamNumberCounter++) {
                        $thisfile_asf_bitratemutualexclusionobject['stream_numbers'][$StreamNumberCounter] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                ...
                case GETID3_ASF_Error_Correction_Object:
                    ...
                    $thisfile_asf_errorcorrectionobject['error_correction_type'] = mb_substr($ASFHeaderData, $offset, 16);
                    $offset += 16;
                    ...
                    $thisfile_asf_errorcorrectionobject['error_correction_data_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                    $offset += 4;
                    switch ($thisfile_asf_errorcorrectionobject['error_correction_type']) {
                        ...
                        case GETID3_ASF_Audio_Spread:
                            ...
                            $thisfile_asf_errorcorrectionobject['span'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 1));
                            $offset += 1;
                            $thisfile_asf_errorcorrectionobject['virtual_packet_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                            $offset += 2;
                            $thisfile_asf_errorcorrectionobject['virtual_chunk_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                            $offset += 2;
                            $thisfile_asf_errorcorrectionobject['silence_data_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                            $offset += 2;
                            $thisfile_asf_errorcorrectionobject['silence_data'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_errorcorrectionobject['silence_data_length']);
                            $offset += $thisfile_asf_errorcorrectionobject['silence_data_length'];
                            break;
                        default:
                            $ThisFileInfo['warning'][] = 'error_correction_object.error_correction_type GUID {' . $this->BytestringToGUID($thisfile_asf_errorcorrectionobject['reserved']) . '} does not match expected "GETID3_ASF_No_Error_Correction" GUID {' . $this->BytestringToGUID(
                ...
                case GETID3_ASF_Content_Description_Object:
                    ...
                    $thisfile_asf_contentdescriptionobject['title_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    $thisfile_asf_contentdescriptionobject['author_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    $thisfile_asf_contentdescriptionobject['copyright_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    $thisfile_asf_contentdescriptionobject['description_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    $thisfile_asf_contentdescriptionobject['rating_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    $thisfile_asf_contentdescriptionobject['title'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_contentdescriptionobject['title_length']);
                    $offset += $thisfile_asf_contentdescriptionobject['title_length'];
                    $thisfile_asf_contentdescriptionobject['author'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_contentdescriptionobject['author_length']);
                    $offset += $thisfile_asf_contentdescriptionobject['author_length'];
                    $thisfile_asf_contentdescriptionobject['copyright'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_contentdescriptionobject['copyright_length']);
                    $offset += $thisfile_asf_contentdescriptionobject['copyright_length'];
                    $thisfile_asf_contentdescriptionobject['description'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_contentdescriptionobject['description_length']);
                    $offset += $thisfile_asf_contentdescriptionobject['description_length'];
                    $thisfile_asf_contentdescriptionobject['rating'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_contentdescriptionobject['rating_length']);
                ...
                case GETID3_ASF_Extended_Content_Description_Object:
                    ...
                    $thisfile_asf_extendedcontentdescriptionobject['content_descriptors_count'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    for ($ExtendedContentDescriptorsCounter = 0; $ExtendedContentDescriptorsCounter < $thisfile_asf_extendedcontentdescriptionobject['content_descriptors_count']; $ExtendedContentDescriptorsCounter++) {
                        ...
                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));

                        $offset += 2;

                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name_length']);

                        $offset += $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name_length'];

                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_type'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));

                        $offset += 2;

                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_length'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));

                        $offset += 2;

                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_length']);
                        ...
                        switch ($this->TrimConvert(mb_strtolower($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name']))) {
                            case 'wm/albumartist':
                            case 'artist':
                                $thisfile_asf_comments['artist'] = [$this->TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                                break;
                            case 'wm/albumtitle':
                            case 'album':
                            ...
                            case 'genre':
                                ...
                                $thisfile_asf_comments['genre'] = [$genre];
                                break;
                            case 'wm/tracknumber':
                            case 'tracknumber':
                                $thisfile_asf_comments['track'] = [(int)$this->TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                                break;
                            case 'wm/track':
                            ...
                            case 'id3':
                                ...
                                if (class_exists('getid3_id3v2')) {
                                    if ($tempfilehandle = tmpfile()) {
                                        $tempThisfileInfo = ['encoding' => $ThisFileInfo['encoding']];
                            ...
                            case 'wm/picture':
                                ...
                                $wm_picture_offset = 0;
                                $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['image_type_id'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'], $wm_picture_offset, 1));
                                $wm_picture_offset += 1;
                                ...
                                $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['image_size'] = getid3_lib::LittleEndian2Int(mb_substr($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'], $wm_picture_offset, 4));
                                $wm_picture_offset += 4;

                                $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['image_mime'] = '';
                                do {
                                    $next_byte_pair = mb_substr($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'], $wm_picture_offset, 2);
                                ...
                                $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['data'] = mb_substr($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'], $wm_picture_offset);
                            ...
                            default:
                                switch ($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_type']) {
                                    case 0: // Unicode string
                                        if ('WM/' == mb_substr($this->TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name']), 0, 3)) {
                                            $thisfile_asf_comments[str_replace('wm/', '', mb_strtolower($this->TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name'])))] = [
                                                $this->TrimTerm(
                ...
                case GETID3_ASF_Stream_Bitrate_Properties_Object:
                    ...
                    $thisfile_asf_streambitrateproperties['bitrate_records_count'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                    $offset += 2;
                    for ($BitrateRecordsCounter = 0; $BitrateRecordsCounter < $thisfile_asf_streambitrateproperties['bitrate_records_count']; $BitrateRecordsCounter++) {
                        $thisfile_asf_streambitrateproperties['bitrate_records'][$BitrateRecordsCounter]['flags_raw'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 2));
                        ...
                        $thisfile_asf_streambitrateproperties['bitrate_records'][$BitrateRecordsCounter]['bitrate'] = getid3_lib::LittleEndian2Int(mb_substr($ASFHeaderData, $offset, 4));
                ...
                case GETID3_ASF_Padding_Object:
                    ...
                    $thisfile_asf_paddingobject['padding'] = mb_substr($ASFHeaderData, $offset, $thisfile_asf_paddingobject['padding_length']);
                    break;
            ...
            foreach ($thisfile_asf['stream_properties_object'] as $streamnumber => $streamdata) {
                switch ($streamdata['stream_type']) {
                    case GETID3_ASF_Audio_Media:
                        ...
                        $thisfile_asf_audiomedia_currentstream = getid3_riff::RIFFparseWAVEFORMATex(mb_substr($streamdata['type_specific_data'], $audiomediaoffset, 16));
                        $audiomediaoffset += 16;
                        ...
                        $thisfile_asf_audiomedia_currentstream['codec_data_size'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $audiomediaoffset, 2));
                        $audiomediaoffset += 2;
                        $thisfile_asf_audiomedia_currentstream['codec_data'] = mb_substr($streamdata['type_specific_data'], $audiomediaoffset, $thisfile_asf_audiomedia_currentstream['codec_data_size']);
                    ...
                    case GETID3_ASF_Video_Media:
                        ...
                        $videomediaoffset = 0;
                        $thisfile_asf_videomedia_currentstream['image_width'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['image_height'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['flags'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 1));
                        $videomediaoffset += 1;
                        $thisfile_asf_videomedia_currentstream['format_data_size'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 2));
                        $videomediaoffset += 2;
                        $thisfile_asf_videomedia_currentstream['format_data']['format_data_size'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['format_data']['image_width'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['format_data']['image_height'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['format_data']['reserved'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 2));
                        $videomediaoffset += 2;
                        $thisfile_asf_videomedia_currentstream['format_data']['bits_per_pixel'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 2));
                        $videomediaoffset += 2;
                        $thisfile_asf_videomedia_currentstream['format_data']['codec_fourcc'] = mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4);
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['format_data']['image_size'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['format_data']['horizontal_pels'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['format_data']['vertical_pels'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['format_data']['colors_used'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['format_data']['colors_important'] = getid3_lib::LittleEndian2Int(mb_substr($streamdata['type_specific_data'], $videomediaoffset, 4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['format_data']['codec_data'] = mb_substr($streamdata['type_specific_data'], $videomediaoffset);
        ...
        while (ftell($fd) < $ThisFileInfo['avdataend']) {
            ...
            $NextObjectGUID = mb_substr($NextObjectDataHeader, 0, 16);

            $offset += 16;

            $NextObjectGUIDtext = $this->BytestringToGUID($NextObjectGUID);

            $NextObjectSize = getid3_lib::LittleEndian2Int(mb_substr($NextObjectDataHeader, $offset, 8));
            ...
            switch ($NextObjectGUID) {
                case GETID3_ASF_Data_Object:
                    ...
                    $thisfile_asf_dataobject['fileid'] = mb_substr($DataObjectData, $offset, 16);
                    $offset += 16;
                    $thisfile_asf_dataobject['fileid_guid'] = $this->BytestringToGUID($thisfile_asf_dataobject['fileid']);
                    $thisfile_asf_dataobject['total_data_packets'] = getid3_lib::LittleEndian2Int(mb_substr($DataObjectData, $offset, 8));
                    $offset += 8;
                    $thisfile_asf_dataobject['reserved'] = getid3_lib::LittleEndian2Int(mb_substr($DataObjectData, $offset, 2));
                    $offset += 2;
                    if (0x0101 != $thisfile_asf_dataobject['reserved']) {
                ...
                case GETID3_ASF_Simple_Index_Object:
                    ...
                    $thisfile_asf_simpleindexobject['fileid'] = mb_substr($SimpleIndexObjectData, $offset, 16);
                    $offset += 16;
                    $thisfile_asf_simpleindexobject['fileid_guid'] = $this->BytestringToGUID($thisfile_asf_simpleindexobject['fileid']);
                    $thisfile_asf_simpleindexobject['index_entry_time_interval'] = getid3_lib::LittleEndian2Int(mb_substr($SimpleIndexObjectData, $offset, 8));
                    $offset += 8;
                    $thisfile_asf_simpleindexobject['maximum_packet_count'] = getid3_lib::LittleEndian2Int(mb_substr($SimpleIndexObjectData, $offset, 4));
                    $offset += 4;
                    $thisfile_asf_simpleindexobject['index_entries_count'] = getid3_lib::LittleEndian2Int(mb_substr($SimpleIndexObjectData, $offset, 4));
                    $offset += 4;
                    ...
                    for ($IndexEntriesCounter = 0; $IndexEntriesCounter < $thisfile_asf_simpleindexobject['index_entries_count']; $IndexEntriesCounter++) {
                        $thisfile_asf_simpleindexobject['index_entries'][$IndexEntriesCounter]['packet_number'] = getid3_lib::LittleEndian2Int(mb_substr($IndexEntriesData, $offset, 4));

                        $offset += 4;

                        $thisfile_asf_simpleindexobject['index_entries'][$IndexEntriesCounter]['packet_count'] = getid3_lib::LittleEndian2Int(mb_substr($IndexEntriesData, $offset, 4));
                ...
                case GETID3_ASF_Index_Object:
                    ...
                    $thisfile_asf_asfindexobject['entry_time_interval'] = getid3_lib::LittleEndian2Int(mb_substr($ASFIndexObjectData, $offset, 4));
                    $offset += 4;
                    $thisfile_asf_asfindexobject['index_specifiers_count'] = getid3_lib::LittleEndian2Int(mb_substr($ASFIndexObjectData, $offset, 2));
                    $offset += 2;
                    $thisfile_asf_asfindexobject['index_blocks_count'] = getid3_lib::LittleEndian2Int(mb_substr($ASFIndexObjectData, $offset, 4));
                    $offset += 4;
                    ...
                    for ($IndexSpecifiersCounter = 0; $IndexSpecifiersCounter < $thisfile_asf_asfindexobject['index_specifiers_count']; $IndexSpecifiersCounter++) {
                        $IndexSpecifierStreamNumber = getid3_lib::LittleEndian2Int(mb_substr($ASFIndexObjectData, $offset, 2));

                        $offset += 2;

                        $thisfile_asf_asfindexobject['index_specifiers'][$IndexSpecifiersCounter]['stream_number'] = $IndexSpecifierStreamNumber;

                        $thisfile_asf_asfindexobject['index_specifiers'][$IndexSpecifiersCounter]['index_type'] = getid3_lib::LittleEndian2Int(mb_substr($ASFIndexObjectData, $offset, 2));
                    ...
                    $thisfile_asf_asfindexobject['index_entry_count'] = getid3_lib::LittleEndian2Int(mb_substr($ASFIndexObjectData, $offset, 4));
                    $offset += 4;

                    $ASFIndexObjectData .= fread($fd, 8 * $thisfile_asf_asfindexobject['index_specifiers_count']);
                    for ($IndexSpecifiersCounter = 0; $IndexSpecifiersCounter < $thisfile_asf_asfindexobject['index_specifiers_count']; $IndexSpecifiersCounter++) {
                        $thisfile_asf_asfindexobject['block_positions'][$IndexSpecifiersCounter] = getid3_lib::LittleEndian2Int(mb_substr($ASFIndexObjectData, $offset, 8));
                    ...
                    for ($IndexEntryCounter = 0; $IndexEntryCounter < $thisfile_asf_asfindexobject['index_entry_count']; $IndexEntryCounter++) {
                        for ($IndexSpecifiersCounter = 0; $IndexSpecifiersCounter < $thisfile_asf_asfindexobject['index_specifiers_count']; $IndexSpecifiersCounter++) {
                            $thisfile_asf_asfindexobject['offsets'][$IndexSpecifiersCounter][$IndexEntryCounter] = getid3_lib::LittleEndian2Int(mb_substr($ASFIndexObjectData, $offset, 4));
                ...
                switch ($streamdata['information']) {
                    ...
                    default:
                        switch ($streamdata['type_raw']) {
                            case 1:
                                if (mb_strstr($this->TrimConvert($streamdata['name']), 'Windows Media')) {
                                    $thisfile_video['dataformat'] = 'wmv';

                                    if ('video/x-ms-asf' == $ThisFileInfo['mime_type']) {
                                        $ThisFileInfo['mime_type'] = 'video/x-ms-wmv';
                                    }
                                }
                                break;
    ...
    public function ASFCodecListObjectTypeLookup($CodecListType)
    {
    ...
    public function GUIDname($GUIDstring)
    {
        static $GUIDarray = [];
    ...
    public function ASFIndexObjectIndexTypeLookup($id)
    {
    ...
    public function GUIDtoBytestring($GUIDstring)
    {
        ...
        $hexbytecharstring = chr(hexdec(mb_substr($GUIDstring, 6, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 4, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 2, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 0, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 11, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 9, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 16, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 14, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 19, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 21, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 24, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 26, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 28, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 30, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 32, 2)));

        $hexbytecharstring .= chr(hexdec(mb_substr($GUIDstring, 34, 2)));

        return $hexbytecharstring;
    }

    public function BytestringToGUID($Bytestring)
    {
        ...
        return mb_strtoupper($GUIDstring);
    }

    public function FILETIMEtoUNIXtime($FILETIME, $round = true)
    {
    ...
    public function WMpictureTypeLookup($WMpictureType)
    {
    ...
    public function TrimConvert($string)
    {
        // remove terminator, only if present (it should be, but...)

        if ("\x00\x00" == mb_substr($string, mb_strlen($string) - 2, 2)) {
    ...
    public function TrimTerm($string)
    {
        // remove terminator, only if present (it should be, but...)

        if ("\x00\x00" == mb_substr($string, -2)) {
            $string = mb_substr($string, 0, -2);
        }
