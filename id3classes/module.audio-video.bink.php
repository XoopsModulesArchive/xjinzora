...
class getid3_bink
{
    ...
    public function ParseBink($fd, &$ThisFileInfo)
    {
        ...
        $ThisFileInfo['bink']['data_size'] = getid3_lib::LittleEndian2Int(mb_substr($fileData, 4, 4));

        $ThisFileInfo['bink']['frame_count'] = getid3_lib::LittleEndian2Int(mb_substr($fileData, 8, 2));
    ...
    public function ParseSmacker(&$fd, &$ThisFileInfo)
    {
