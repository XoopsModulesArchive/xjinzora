...
class getid3_tta
{
    public function __construct($fd, &$ThisFileInfo)
    {
        ...
        $ThisFileInfo['tta']['magic'] = mb_substr($ttaheader, 0, 3);

        if ('TTA' != $ThisFileInfo['tta']['magic']) {
        ...
        switch ($ttaheader[3]) {
            ...
            case "\x03":
                ...
                $ThisFileInfo['tta']['channels'] = getid3_lib::LittleEndian2Int(mb_substr($ttaheader, 4, 2));
                $ThisFileInfo['tta']['bits_per_sample'] = getid3_lib::LittleEndian2Int(mb_substr($ttaheader, 6, 2));
                $ThisFileInfo['tta']['sample_rate'] = getid3_lib::LittleEndian2Int(mb_substr($ttaheader, 8, 4));
                $ThisFileInfo['tta']['samples_per_channel'] = getid3_lib::LittleEndian2Int(mb_substr($ttaheader, 12, 4));
            ...
            case '2':
                ...
                $ThisFileInfo['tta']['compression_level'] = getid3_lib::LittleEndian2Int(mb_substr($ttaheader, 4, 2));
                $ThisFileInfo['tta']['audio_format'] = getid3_lib::LittleEndian2Int(mb_substr($ttaheader, 6, 2));
                $ThisFileInfo['tta']['channels'] = getid3_lib::LittleEndian2Int(mb_substr($ttaheader, 8, 2));
                $ThisFileInfo['tta']['bits_per_sample'] = getid3_lib::LittleEndian2Int(mb_substr($ttaheader, 10, 2));
                $ThisFileInfo['tta']['sample_rate'] = getid3_lib::LittleEndian2Int(mb_substr($ttaheader, 12, 4));
                $ThisFileInfo['tta']['data_length'] = getid3_lib::LittleEndian2Int(mb_substr($ttaheader, 16, 4));
