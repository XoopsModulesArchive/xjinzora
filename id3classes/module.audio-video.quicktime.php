...
{
    public function __construct($fd, &$ThisFileInfo, $ReturnAtomData = true, $ParseAllPossibleAtoms = false)
    {
        ...
        while ($offset < $ThisFileInfo['avdataend']) {
            ...
            $ThisFileInfo['quicktime'][(string)$atomname]['name']   = $atomname;
            $ThisFileInfo['quicktime'][(string)$atomname]['size']   = $atomsize;
            $ThisFileInfo['quicktime'][(string)$atomname]['offset'] = $offset;
            ...
            switch ($atomname) {
                case 'mdat': // Media DATa atom
                    ...
                    if (($atomsize > 8) && (!isset($ThisFileInfo['avdataend_tmp']) || ($ThisFileInfo['quicktime'][(string)$atomname]['size'] > ($ThisFileInfo['avdataend_tmp'] - $ThisFileInfo['avdataoffset'])))) {
                        $ThisFileInfo['avdataoffset'] = $ThisFileInfo['quicktime'][(string)$atomname]['offset'] + 8;
                        $OldAVDataEnd                 = $ThisFileInfo['avdataend'];
                        $ThisFileInfo['avdataend']    = $ThisFileInfo['quicktime'][(string)$atomname]['offset'] + $ThisFileInfo['quicktime'][(string)$atomname]['size'];
                ...
                default:
                    $atomHierarchy                                = [];
                    $ThisFileInfo['quicktime'][(string)$atomname] = $this->QuicktimeParseAtom($atomname, $atomsize, fread($fd, $atomsize), $ThisFileInfo, $offset, $atomHierarchy, $ParseAllPossibleAtoms);
                    break;
            }
    ...
    public function QuicktimeParseAtom($atomname, $atomsize, $atomdata, &$ThisFileInfo, $baseoffset, &$atomHierarchy, $ParseAllPossibleAtoms)
    {
    ...
    public function QuicktimeParseContainerAtom($atomdata, &$ThisFileInfo, $baseoffset, &$atomHierarchy, $ParseAllPossibleAtoms)
    {
        $atomstructure  = false;
        $subatomoffset  = 0;
        $subatomcounter = 0;
    ...
    public function QuicktimeVideoCodecLookup($codecid)
    {
        ...
        return ($QuicktimeVideoCodecLookup[(string)$codecid] ?? '');
    }
    ...
    public function QuicktimeAudioCodecLookup($codecid)
    {
        ...
        return ($QuicktimeAudioCodecLookup[(string)$codecid] ?? '');
    }
    ...
    public function QuicktimeDCOMLookup($compressionid)
    {
        ...
        return ($QuicktimeDCOMLookup[(string)$compressionid] ?? '');
    }
    ...
    public function CopyToAppropriateCommentsSection($keyname, $data, &$ThisFileInfo)
    {
        static $handyatomtranslatorarray = [];
        if (empty($handyatomtranslatorarray)) {
            $handyatomtranslatorarray['妾py'] = 'copyright';
            $handyatomtranslatorarray['妻ay'] = 'creation_date';
            $handyatomtranslatorarray['妻ir'] = 'director';
            $handyatomtranslatorarray['委d1'] = 'edit1';
            $handyatomtranslatorarray['委d2'] = 'edit2';
            $handyatomtranslatorarray['委d3'] = 'edit3';
            $handyatomtranslatorarray['委d4'] = 'edit4';
            $handyatomtranslatorarray['委d5'] = 'edit5';
            $handyatomtranslatorarray['委d6'] = 'edit6';
            $handyatomtranslatorarray['委d7'] = 'edit7';
            $handyatomtranslatorarray['委d8'] = 'edit8';
            $handyatomtranslatorarray['委d9'] = 'edit9';
            $handyatomtranslatorarray['妹mt'] = 'format';
            $handyatomtranslatorarray['姆nf'] = 'information';
            $handyatomtranslatorarray['妳rd'] = 'producer';
            $handyatomtranslatorarray['妳rf'] = 'performers';
            $handyatomtranslatorarray['姅eq'] = 'system_requirements';
            $handyatomtranslatorarray['孟rc'] = 'source_credit';
            $handyatomtranslatorarray['定rt'] = 'writer';

            // http://www.geocities.com/xhelmboyx/quicktime/formats/qtm-layout.txt
            $handyatomtranslatorarray['姊am'] = 'title';
            $handyatomtranslatorarray['妾mt'] = 'comment';
            $handyatomtranslatorarray['定rn'] = 'warning';
            $handyatomtranslatorarray['姑st'] = 'host_computer';
            $handyatomtranslatorarray['姓ak'] = 'make';
            $handyatomtranslatorarray['姓od'] = 'model';
            $handyatomtranslatorarray['周RD'] = 'product';
            $handyatomtranslatorarray['孟wr'] = 'software';
            $handyatomtranslatorarray['奄ut'] = 'author';
            $handyatomtranslatorarray['呸RT'] = 'artist';
            $handyatomtranslatorarray['孤rk'] = 'track';
            $handyatomtranslatorarray['奄lb'] = 'album';
            $handyatomtranslatorarray['妾om'] = 'comment';
            $handyatomtranslatorarray['妮en'] = 'genre';
            $handyatomtranslatorarray['妯pe'] = 'composer';
            $handyatomtranslatorarray['季rl'] = 'url';
            $handyatomtranslatorarray['委nc'] = 'encoder';
        }
        if (isset($handyatomtranslatorarray[(string)$keyname])) {
            $ThisFileInfo['quicktime']['comments'][$handyatomtranslatorarray[(string)$keyname]][] = $data;
        }
    ...
    public function NoNullString($nullterminatedstring)
    {
        ...
        if (substr($nullterminatedstring, strlen($nullterminatedstring) - 1, 1) === "\x00") {
            return substr($nullterminatedstring, 0, -1);
        }
