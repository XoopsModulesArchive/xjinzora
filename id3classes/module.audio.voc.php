...
class getid3_voc
{
    public function __construct($fd, &$ThisFileInfo)
    {
        ...
        if ('Creative Voice File' != mb_substr($VOCheader, 0, 19)) {
            $ThisFileInfo['error'][] = 'Expecting "Creative Voice File" at offset ' . $ThisFileInfo['avdataoffset'] . ', found "' . mb_substr($VOCheader, 0, 19) . '"';
        ...
        $thisfile_voc['header']['datablock_offset'] = getid3_lib::LittleEndian2Int(mb_substr($VOCheader, 20, 2));

        $thisfile_voc['header']['minor_version'] = getid3_lib::LittleEndian2Int(mb_substr($VOCheader, 22, 1));

        $thisfile_voc['header']['major_version'] = getid3_lib::LittleEndian2Int(mb_substr($VOCheader, 23, 1));
        ...
        do {
            ...
            $BlockSize = getid3_lib::LittleEndian2Int(mb_substr($BlockData, 1, 3));
            ...
            switch ($BlockType) {
                ...
                case 1:  // Sound data
                    ...
                    $ThisBlock['sample_rate_id'] = getid3_lib::LittleEndian2Int(mb_substr($BlockData, 4, 1));
                    $ThisBlock['compression_type'] = getid3_lib::LittleEndian2Int(mb_substr($BlockData, 5, 1));
                ...
                case 8:  // Extended
                    ...
                    $ThisBlock['time_constant'] = getid3_lib::LittleEndian2Int(mb_substr($BlockData, 4, 2));
                    $ThisBlock['pack_method'] = getid3_lib::LittleEndian2Int(mb_substr($BlockData, 6, 1));
                    $ThisBlock['stereo'] = (bool)getid3_lib::LittleEndian2Int(mb_substr($BlockData, 7, 1));
                ...
                case 9:  // data block that supersedes blocks 1 and 8. Used for stereo, 16 bit
                    ...
                    $ThisBlock['sample_rate'] = getid3_lib::LittleEndian2Int(mb_substr($BlockData, 4, 4));
                    $ThisBlock['bits_per_sample'] = getid3_lib::LittleEndian2Int(mb_substr($BlockData, 8, 1));
                    $ThisBlock['channels'] = getid3_lib::LittleEndian2Int(mb_substr($BlockData, 9, 1));
                    $ThisBlock['wFormat'] = getid3_lib::LittleEndian2Int(mb_substr($BlockData, 10, 2));
    ...
    public function VOCcompressionTypeLookup($index)
    {
        ...
        return ($VOCcompressionTypeLookup[$index] ?? 'Multi DAC (' . ($index - 3) . ') channels');
    }
    ...
    public function VOCwFormatLookup($index)
    {
        ...
        return ($VOCwFormatLookup[$index] ?? false);
    }
